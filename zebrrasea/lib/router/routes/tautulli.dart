...
import 'package:zebrrasea/api/tautulli/types.dart';
import 'package:zebrrasea/modules.dart';
import 'package:zebrrasea/modules/tautulli/core/state.dart';
import 'package:zebrrasea/modules/tautulli/routes/activity_details/route.dart';
import 'package:zebrrasea/modules/tautulli/routes/check_for_updates/route.dart';
import 'package:zebrrasea/modules/tautulli/routes/graphs/route.dart';
import 'package:zebrrasea/modules/tautulli/routes/history_details/route.dart';
import 'package:zebrrasea/modules/tautulli/routes/ipaddress_details/route.dart';
import 'package:zebrrasea/modules/tautulli/routes/libraries/route.dart';
import 'package:zebrrasea/modules/tautulli/routes/libraries_details/route.dart';
import 'package:zebrrasea/modules/tautulli/routes/logs/route.dart';
import 'package:zebrrasea/modules/tautulli/routes/logs_logins/route.dart';
import 'package:zebrrasea/modules/tautulli/routes/logs_newsletters/route.dart';
import 'package:zebrrasea/modules/tautulli/routes/logs_notifications/route.dart';
import 'package:zebrrasea/modules/tautulli/routes/logs_plex_media_scanner/route.dart';
import 'package:zebrrasea/modules/tautulli/routes/logs_plex_media_server/route.dart';
import 'package:zebrrasea/modules/tautulli/routes/logs_tautulli/route.dart';
import 'package:zebrrasea/modules/tautulli/routes/media_details/route.dart';
import 'package:zebrrasea/modules/tautulli/routes/recently_added/route.dart';
import 'package:zebrrasea/modules/tautulli/routes/search/route.dart';
import 'package:zebrrasea/modules/tautulli/routes/statistics/route.dart';
import 'package:zebrrasea/modules/tautulli/routes/synced_items/route.dart';
import 'package:zebrrasea/modules/tautulli/routes/tautulli/route.dart';
import 'package:zebrrasea/modules/tautulli/routes/users_details/route.dart';
import 'package:zebrrasea/router/routes.dart';
import 'package:zebrrasea/vendor.dart';

enum TautulliRoutes with ZebrraRoutesMixin {
  HOME('/tautulli'),
  ...
  @override
  ZebrraModule get module => ZebrraModule.TAUTULLI;
