...
class ZebrraBlock extends StatelessWidget {
  static const TITLE_HEIGHT = ZebrraUI.FONT_SIZE_H2 + 4.0;
  static const SUBTITLE_HEIGHT = ZebrraUI.FONT_SIZE_H3 + 4.0;
  ...
  const ZebrraBlock({
    ...
    this.bodyLeadingIconsColor = ZebrraColours.accent,
    this.bottom,
  ...
  static double calculateItemExtent(
    ...
    return height + ZebrraUI.MARGIN_H_DEFAULT_V_HALF.vertical;
  }
  ...
  static double calculateItemHeight(
    ...
    double height = (ZebrraUI.DEFAULT_MARGIN_SIZE * 2) + TITLE_HEIGHT;
  ...
  Widget _poster(BuildContext context, double height) {
    double _dimension = height - ZebrraUI.DEFAULT_MARGIN_SIZE;

    if (skeletonEnabled) {
      return Padding(
        padding: const EdgeInsets.only(left: ZebrraUI.MARGIN_SIZE_HALF),
        child: Container(
          height: _dimension,
  ...
  Widget _tile(BuildContext context, double height) {
      ...
      return Expanded(
        child: Padding(
          child: Column(
            ...
            children: [
              Container(
                height: ZebrraBlock.TITLE_HEIGHT - 4.0,
              ...
              ...List.generate(skeletonSubtitles, (_) {
                return Container(
                  height: ZebrraBlock.SUBTITLE_HEIGHT - 6.0,
    ...
    return Expanded(
      ...
      child: ZebrraListTile(
        context: context,
        title: _scrollableText(
          child: ZebrraText.title(
            text: title ?? ZebrraUI.TEXT_EMDASH,
            color: titleColor,
