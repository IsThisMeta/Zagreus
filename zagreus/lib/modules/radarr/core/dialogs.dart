...
class RadarrDialogs {
  ...
  Future<Tuple2<bool, RadarrImportMode?>> setManualImportMode(
    ...
    await ZagDialog.dialog(
      ...
      content: List.generate(
        ...
        (index) => ZagDialog.tile(
          text: RadarrImportMode.values[index].zagReadable,
          icon: RadarrImportMode.values[index].zagIcon,
          iconColor: ZagColours().byListIndex(index),
    ...
    await showDialog(
      ...
      builder: (_) => ChangeNotifierProvider.value(
        ...
        builder: (context, _) => AlertDialog(
          ...
          title: ZagDialog.title(text: 'radarr.Languages'.tr()),
          content: Consumer<RadarrManualImportDetailsTileState>(
            builder: (context, manualImport, _) => ZagDialog.content(
          ...
          builder: (context, future, _) => FutureBuilder(
            ...
            builder: (context, AsyncSnapshot<List<RadarrTag>> snapshot) {
              return AlertDialog(
                ...
                title: ZagDialog.title(text: 'radarr.Tags'.tr()),
                content: Builder(
                  builder: (context) {
  ...
  Future<bool> moveFiles() async {
    ...
    void _setValues(bool flag) {
      _flag = flag;
      Navigator.of(ZagState.context, rootNavigator: true).pop();
    }
    ...
    await ZagDialog.dialog(
      ...
      contentPadding: ZagDialog.textDialogContentPadding(),
      cancelButtonText: 'zagreus.No'.tr(),
      buttons: [
        ZagDialog.button(
          text: 'zagreus.Yes'.tr(),
          onPressed: () => _setValues(true),
      ...
      content: [
        ZagDialog.textContent(text: 'radarr.MoveFilesDescription'.tr()),
      ],
    );
