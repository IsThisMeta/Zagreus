...
class _State extends State<SonarrSeriesTile> {
  ...
  TextSpan _subtitle2() {
    return TextSpan(
      children: [
        _buildChildTextSpan(
          widget.series.zagSeriesType,
          SonarrSeriesSorting.TYPE,
        ),
        TextSpan(text: ZagUI.TEXT_BULLET.pad()),
        _buildChildTextSpan(
          widget.profile?.name ?? ZagUI.TEXT_EMDASH,
