...
import 'package:zebrrasea/api/sonarr/models.dart';
import 'package:zebrrasea/modules.dart';
import 'package:zebrrasea/modules/sonarr/core/state.dart';
import 'package:zebrrasea/modules/sonarr/routes/add_series/route.dart';
import 'package:zebrrasea/modules/sonarr/routes/add_series_details/route.dart';
import 'package:zebrrasea/modules/sonarr/routes/edit_series/route.dart';
import 'package:zebrrasea/modules/sonarr/routes/history/route.dart';
import 'package:zebrrasea/modules/sonarr/routes/queue/route.dart';
import 'package:zebrrasea/modules/sonarr/routes/releases/route.dart';
import 'package:zebrrasea/modules/sonarr/routes/season_details/route.dart';
import 'package:zebrrasea/modules/sonarr/routes/series_details/route.dart';
import 'package:zebrrasea/modules/sonarr/routes/sonarr/route.dart';
import 'package:zebrrasea/modules/sonarr/routes/tags/route.dart';
import 'package:zebrrasea/router/routes.dart';
import 'package:zebrrasea/vendor.dart';

enum SonarrRoutes with ZebrraRoutesMixin {
  HOME('/sonarr'),
  ...
  @override
  ZebrraModule get module => ZebrraModule.SONARR;
