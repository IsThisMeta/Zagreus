...
extension StringNullableExtension on String? {
  ...
  String uiSafe({
    ...
    if (!isEmptySafe && this!.isEmpty) return ZebrraUI.TEXT_EMDASH;
    return this!;
  }
}
...
extension StringExtension on String {
  ...
  Future<void> copyToClipboard({
    ...
    if (showSnackBar) {
      showZebrraSuccessSnackBar(
        title: 'zebrrasea.Copied'.tr(),
        message: 'zebrrasea.CopiedContentToTheClipboard'.tr(),
      );
    }
  }
  ...
  String bulleted({
    String bullet = ZebrraUI.TEXT_BULLET,
    int padCount = 1,
  }) {
