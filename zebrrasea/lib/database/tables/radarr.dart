...
import 'package:zebrrasea/modules/radarr/core/types/filter_movies.dart';
import 'package:zebrrasea/modules/radarr/core/types/filter_releases.dart';
import 'package:zebrrasea/modules/radarr/core/types/sorting_movies.dart';
import 'package:zebrrasea/modules/radarr/core/types/sorting_releases.dart';
import 'package:zebrrasea/vendor.dart';

enum RadarrDatabase<T> with ZebrraTableMixin<T> {
  NAVIGATION_INDEX<int>(0),
  NAVIGATION_INDEX_MOVIE_DETAILS<int>(0),
  NAVIGATION_INDEX_ADD_MOVIE<int>(0),
  NAVIGATION_INDEX_SYSTEM_STATUS<int>(0),
  DEFAULT_VIEW_MOVIES<ZebrraListViewOption>(ZebrraListViewOption.BLOCK_VIEW),
  ...
  @override
  ZebrraTable get table => ZebrraTable.radarr;
