...
class ZagFirebaseMessaging {
  ...
  StreamSubscription<RemoteMessage> registerOnMessageListener() {
    return onMessage.listen((message) {
      if (!ZagDatabase.ENABLE_IN_APP_NOTIFICATIONS.read()) return;
