...
import 'package:zebrrasea/modules/sonarr/core/types/filter_releases.dart';
import 'package:zebrrasea/modules/sonarr/core/types/filter_series.dart';
import 'package:zebrrasea/modules/sonarr/core/types/monitor_status.dart';
import 'package:zebrrasea/modules/sonarr/core/types/sorting_releases.dart';
import 'package:zebrrasea/modules/sonarr/core/types/sorting_series.dart';
import 'package:zebrrasea/types/list_view_option.dart';
import 'package:zebrrasea/vendor.dart';

enum SonarrDatabase<T> with ZebrraTableMixin<T> {
  ...
  DEFAULT_VIEW_SERIES<ZebrraListViewOption>(ZebrraListViewOption.BLOCK_VIEW),
  ...
  @override
  ZebrraTable get table => ZebrraTable.sonarr;
  ...
  void import(dynamic value) {
    ...
    switch (db) {
      ...
      case SonarrDatabase.DEFAULT_FILTERING_RELEASES:
        ...
        break;
      case SonarrDatabase.DEFAULT_VIEW_SERIES:
        result = ZebrraListViewOption.fromKey(value.toString());
        break;
      default:
        result = value;
        break;
