...
import 'package:zebrrasea/api/radarr/models/movie/movie.dart';
import 'package:zebrrasea/modules.dart';
import 'package:zebrrasea/modules/radarr/core/state.dart';
import 'package:zebrrasea/modules/radarr/routes/add_movie/route.dart';
import 'package:zebrrasea/modules/radarr/routes/add_movie_details/route.dart';
import 'package:zebrrasea/modules/radarr/routes/edit_movie/route.dart';
import 'package:zebrrasea/modules/radarr/routes/history/route.dart';
import 'package:zebrrasea/modules/radarr/routes/manual_import/route.dart';
import 'package:zebrrasea/modules/radarr/routes/manual_import_details/route.dart';
import 'package:zebrrasea/modules/radarr/routes/movie_details/route.dart';
import 'package:zebrrasea/modules/radarr/routes/queue/route.dart';
import 'package:zebrrasea/modules/radarr/routes/radarr/route.dart';
import 'package:zebrrasea/modules/radarr/routes/releases/route.dart';
import 'package:zebrrasea/modules/radarr/routes/system_status/route.dart';
import 'package:zebrrasea/modules/radarr/routes/tags/route.dart';
import 'package:zebrrasea/router/routes.dart';
import 'package:zebrrasea/vendor.dart';

enum RadarrRoutes with ZebrraRoutesMixin {
  HOME('/radarr'),
  ADD_MOVIE('add_movie'),
  ...
  @override
  ZebrraModule get module => ZebrraModule.RADARR;
