...
extension IntegerAsDurationExtension on int? {
  ...
  String asWordDuration({
    ...
    if (this == null || this! <= 0) return 'zebrrasea.Unknown'.tr();
    ...
    if (hours > 1) {
      return 'zebrrasea.Hours'.tr(args: [hours.toString()]);
    }

    final minutes = seconds ~/ _MINUTE_IN_SECONDS;
    if (minutes > 0) {
      return 'zebrrasea.Minutes'.tr(args: [minutes.toString()]);
    }

    return 'zebrrasea.Seconds'.tr(args: [seconds.toString()]);
  }
