...
class _State extends State<TMDBPopularMoviesRoute> with ZagScrollControllerMixin {
  ...
  Future<void> _loadMoreMovies() async {
    ...
    try {
      ...
      final movies = await TMDBApi.getPopularMovies(page: nextPage, region: region);
