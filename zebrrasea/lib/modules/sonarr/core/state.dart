...
class SonarrState extends ZebrraModuleState {
  SonarrState() {
    reset();
  }
  ...
  ZebrraListViewOption _seriesViewType =
      SonarrDatabase.DEFAULT_VIEW_SERIES.read();
  ZebrraListViewOption get seriesViewType => _seriesViewType;
  set seriesViewType(ZebrraListViewOption seriesViewType) {
