...
import 'package:zebrrasea/system/cache/memory/memory_cache.dart';
...
class SonarrSeasonDetailsState extends ChangeNotifier {
  ...
  ZebrraLoadingState _episodeSearchState = ZebrraLoadingState.INACTIVE;
  ZebrraLoadingState get episodeSearchState => _episodeSearchState;
  set episodeSearchState(ZebrraLoadingState state) {
    _episodeSearchState = state;
    notifyListeners();
  }

  final _episodeHistoryCache = ZebrraMemoryCache<Future<SonarrHistoryPage>>(
    maxEntries: 10,
