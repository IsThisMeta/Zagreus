...
ZebrraSea is available on iOS 11.0+.

Note that installation of iOS app package (`.ipa`) files is a relatively advanced task and instructions are outside the scope of ZebrraSea's documentation and no support will be provided.
...
The easiest way for most users with iOS devices who want stable releases would be to download releases of ZebrraSea directly from the [App Store](https://www.zebrrasea.app/appstore)!
...
All iOS releases are available in the [Build Bucket](https://builds.zebrrasea.app/#latest/)!
