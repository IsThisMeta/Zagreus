...
class _State extends State<ConfigurationSonarrConnectionDetailsRoute>
  ...
  Widget _host() {
    String host = ZebrraProfile.current.sonarrHost;
    return ZebrraBlock(
      ...
      onTap: () async {
        ...
        if (_values.item1) {
          ZebrraProfile.current.sonarrHost = _values.item2;
  ...
  Widget _apiKey() {
    String apiKey = ZebrraProfile.current.sonarrKey;
    return ZebrraBlock(
      ...
      onTap: () async {
        ...
        if (_values.item1) {
          ZebrraProfile.current.sonarrKey = _values.item2;
          ZebrraProfile.current.save();
          context.read<SonarrState>().reset();
        }
      },
        ...
        if (_profile.sonarrHost.isEmpty) {
          showZebrraErrorSnackBar(
            ...
            message: 'settings.HostRequiredMessage'
                .tr(args: [ZebrraModule.SONARR.title]),
          );
          return;
        }
