...
import 'package:zebrrasea/modules/settings/routes/configuration/route.dart';
import 'package:zebrrasea/modules/settings/routes/configuration_general/route.dart';
import 'package:zebrrasea/modules/settings/routes/configuration_dashboard/pages/calendar_settings.dart';
import 'package:zebrrasea/modules/settings/routes/configuration_dashboard/pages/default_pages.dart';
import 'package:zebrrasea/modules/settings/routes/configuration_dashboard/route.dart';
import 'package:zebrrasea/modules/settings/routes/configuration_drawer/route.dart';
import 'package:zebrrasea/modules/settings/routes/configuration_external_modules/pages/add_module.dart';
import 'package:zebrrasea/modules/settings/routes/configuration_external_modules/pages/edit_module.dart';
import 'package:zebrrasea/modules/settings/routes/configuration_external_modules/route.dart';
import 'package:zebrrasea/modules/settings/routes/configuration_lidarr/pages/connection_details.dart';
import 'package:zebrrasea/modules/settings/routes/configuration_lidarr/pages/default_pages.dart';
import 'package:zebrrasea/modules/settings/routes/configuration_lidarr/pages/headers.dart';
import 'package:zebrrasea/modules/settings/routes/configuration_lidarr/route.dart';
import 'package:zebrrasea/modules/settings/routes/configuration_nzbget/pages/connection_details.dart';
import 'package:zebrrasea/modules/settings/routes/configuration_nzbget/pages/default_pages.dart';
import 'package:zebrrasea/modules/settings/routes/configuration_nzbget/pages/headers.dart';
import 'package:zebrrasea/modules/settings/routes/configuration_nzbget/route.dart';
import 'package:zebrrasea/modules/settings/routes/configuration_quick_actions/route.dart';
import 'package:zebrrasea/modules/settings/routes/configuration_radarr/pages/connection_details.dart';
import 'package:zebrrasea/modules/settings/routes/configuration_radarr/pages/default_options.dart';
import 'package:zebrrasea/modules/settings/routes/configuration_radarr/pages/default_pages.dart';
import 'package:zebrrasea/modules/settings/routes/configuration_radarr/pages/headers.dart';
import 'package:zebrrasea/modules/settings/routes/configuration_radarr/route.dart';
import 'package:zebrrasea/modules/settings/routes/configuration_sabnzbd/pages/connection_details.dart';
import 'package:zebrrasea/modules/settings/routes/configuration_sabnzbd/pages/default_pages.dart';
import 'package:zebrrasea/modules/settings/routes/configuration_sabnzbd/pages/headers.dart';
import 'package:zebrrasea/modules/settings/routes/configuration_sabnzbd/route.dart';
import 'package:zebrrasea/modules/settings/routes/configuration_search/pages/add_indexer.dart';
import 'package:zebrrasea/modules/settings/routes/configuration_search/pages/add_indexer_headers.dart';
import 'package:zebrrasea/modules/settings/routes/configuration_search/pages/edit_indexer.dart';
import 'package:zebrrasea/modules/settings/routes/configuration_search/pages/edit_indexer_headers.dart';
import 'package:zebrrasea/modules/settings/routes/configuration_search/route.dart';
import 'package:zebrrasea/modules/settings/routes/configuration_sonarr/pages/connection_details.dart';
import 'package:zebrrasea/modules/settings/routes/configuration_sonarr/pages/default_options.dart';
import 'package:zebrrasea/modules/settings/routes/configuration_sonarr/pages/default_pages.dart';
import 'package:zebrrasea/modules/settings/routes/configuration_sonarr/pages/headers.dart';
import 'package:zebrrasea/modules/settings/routes/configuration_sonarr/route.dart';
import 'package:zebrrasea/modules/settings/routes/configuration_tautulli/pages/connection_details.dart';
import 'package:zebrrasea/modules/settings/routes/configuration_tautulli/pages/default_pages.dart';
import 'package:zebrrasea/modules/settings/routes/configuration_tautulli/pages/headers.dart';
import 'package:zebrrasea/modules/settings/routes/configuration_tautulli/route.dart';
import 'package:zebrrasea/modules/settings/routes/configuration_wake_on_lan/route.dart';
import 'package:zebrrasea/modules/settings/routes/profiles/route.dart';
import 'package:zebrrasea/modules/settings/routes/settings/route.dart';
import 'package:zebrrasea/modules/settings/routes/system/route.dart';
import 'package:zebrrasea/modules/settings/routes/system_logs/pages/log_details.dart';
import 'package:zebrrasea/modules/settings/routes/system_logs/route.dart';
...
enum SettingsRoutes with ZebrraRoutesMixin {
  HOME('/settings'),
  ...
  @override
  ZebrraModule get module => ZebrraModule.SETTINGS;
  ...
  GoRoute get routes {
    switch (this) {
      ...
      case SettingsRoutes.CONFIGURATION_SEARCH_ADD_INDEXER_HEADERS:
        return route(builder: (_, state) {
          final indexer = state.extra as ZebrraIndexer?;
      ...
      case SettingsRoutes.SYSTEM_LOGS_DETAILS:
        return route(builder: (_, state) {
          final type = ZebrraLogType.fromKey(state.pathParameters['type']!);
