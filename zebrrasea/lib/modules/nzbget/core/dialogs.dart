...
class NZBGetDialogs {
  ...
  static Future<List<dynamic>> customSpeedLimit(BuildContext context) async {
    ...
    await ZebrraDialog.dialog(
      ...
      content: [
        ZebrraDialog.textContent(text: 'Please enter a speed limit in KB/s.'),
        Form(
          key: _formKey,
          child: ZebrraDialog.textFormInput(
            controller: _textController,
    ...
    await ZebrraDialog.dialog(
      ...
      content: [
        ZebrraDialog.richText(
          children: [
            ZebrraDialog.textSpanContent(text: 'Please enter how long in '),
            ZebrraDialog.bolded(text: 'minutes'),
