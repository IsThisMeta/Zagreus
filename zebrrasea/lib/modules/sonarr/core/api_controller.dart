  ...
  Future<bool> backupDatabase({
    ...
    if (context.read<SonarrState>().enabled) {
      return await context.read<SonarrState>().api!.command.backup().then((_) {
        if (showSnackbar) {
          showZebrraSuccessSnackBar(
            title: 'sonarr.BackingUpDatabase'.tr(args: [ZebrraUI.TEXT_ELLIPSIS]),
  ...
  Future<bool> automaticSeasonSearch({
    ...
    if (context.read<SonarrState>().enabled) {
      return await context
        ...
        if (showSnackbar)
          showZebrraSuccessSnackBar(
            title: 'sonarr.SearchingForSeason'.tr(args: [ZebrraUI.TEXT_ELLIPSIS]),
  ...
  Future<bool> runRSSSync({
    ...
    if (context.read<SonarrState>().enabled) {
      return await context.read<SonarrState>().api!.command.rssSync().then((_) {
        if (showSnackbar)
          showZebrraSuccessSnackBar(
            title: 'sonarr.RunningRSSSync'.tr(args: [ZebrraUI.TEXT_ELLIPSIS]),
  ...
  Future<bool> updateLibrary({
    ...
    if (context.read<SonarrState>().enabled) {
      return await context
        ...
        if (showSnackbar)
          showZebrraSuccessSnackBar(
            title: 'sonarr.UpdatingLibrary'.tr(args: [ZebrraUI.TEXT_ELLIPSIS]),
  ...
  Future<bool> missingEpisodesSearch({
    ...
    if (context.read<SonarrState>().enabled) {
      return await context
        ...
        if (showSnackbar)
          showZebrraSuccessSnackBar(
            title: 'sonarr.Searching'.tr(args: [ZebrraUI.TEXT_ELLIPSIS]),
