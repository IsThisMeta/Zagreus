...
class ZagTextInputBar extends StatefulWidget {
  static const double defaultHeight = 50.0;
  static const double defaultAppBarHeight =
      defaultHeight + ZagUI.DEFAULT_MARGIN_SIZE;
  ...
  const ZagTextInputBar({
    ...
    this.margin = ZagUI.MARGIN_H_DEFAULT_V_HALF,
    this.focusNode,
...
class _State extends State<ZagTextInputBar> {
